...
//TODO: para dibujar tambien necesitaria el cursor
typedef bool (*get_num_buff_cb)(uint8_t * num_buff, uint8_t length);
...
typedef struct EVENTO_SOURCE_GET_NUM_BUFF_PARAMS{
    ...
    get_num_buff_cb is_num_buff_correct;    //funcion que valida que el arreglo de numeros ingresado sea correcto.
    get_num_buff_cb show_num_buff;          //funcion que muestra al usuario el estado del buffer
